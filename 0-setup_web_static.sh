...
# Add the rewrite rule for /redirect_me to redirect to github.com/kisange5
sed -i "/listen \[::\]:80 default_server/ a\\\trewrite ^/redirect_me http://github.com/kisange5 permanent;" /etc/nginx/sites-available/default
